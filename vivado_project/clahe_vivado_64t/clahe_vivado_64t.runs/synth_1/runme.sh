...
HD_PWD='E:/FPGA_codes/CLAHE/vivado_project/clahe_vivado_64t/clahe_vivado_64t.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clahe_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clahe_top.tcl
