...
HD_PWD='E:/FPGA_codes/CLAHE/vivado_project/clahe_vivado_64t/clahe_vivado_64t.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clahe_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clahe_top.tcl -notrace
