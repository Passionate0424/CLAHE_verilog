...
module clahe_top (
    ...
    // ========================================================================
    // 四块并行读取接口
    wire [3:0]  mapping_tl_tile_idx;    // 左上tile索引
    wire [3:0]  mapping_tr_tile_idx;    // 右上tile索引
    wire [3:0]  mapping_bl_tile_idx;    // 左下tile索引
    wire [3:0]  mapping_br_tile_idx;    // 右下tile索引
    ...
    // Debug outputs - expose internal control signals for TB and post-synth sim
